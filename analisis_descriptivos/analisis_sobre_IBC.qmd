...
```{r config_params_querys, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r config_functions, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r load_tablas_supuestos, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r load_tabla_variables_graficas, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r load_master_tables, echo=FALSE, message=FALSE, warning=FALSE}

tabla_personas <- tbl(conexion_bigquery_general, "bases_pila.consolidado_persona")

```

```{r add_fields_personas_table, echo=FALSE, message=FALSE, warning=FALSE }
...
```{r obtener_df_para_graficos, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r palletas_y_homolagacion_nombres, echo=FALSE, message=FALSE}
